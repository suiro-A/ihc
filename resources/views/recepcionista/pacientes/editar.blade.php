...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center gap-4 mb-6">
        <a href="#" class="inline-flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
    ...
    <form action="{{route('paciente.update',['id'=>$paciente->id_paciente])}}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" required
                                   ...
                                   value="{{ old('nombre', $paciente->nombres) }}"
                                   placeholder="Nombres">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" required
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
                                   value="{{ old('fecha_nacimiento', $paciente['fecha_nac']) }}">
                        </div>
                    </div>
                    <!-- Tercera fila: Género -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <select name="genero" id="genero" required
                                ...
                                <option value="1" {{ old('genero', $paciente['sexo']) == '1' ? 'selected' : '' }}>Masculino</option>
                                <option value="0" {{ old('genero', $paciente['sexo']) == '0' ? 'selected' : '' }}>Femenino</option>
                            </select>
                        </div>
                    </div>
                </div>
